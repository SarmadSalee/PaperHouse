...
export const metadata: Metadata = {
  title: 'About — PaperHouse Pakistan',
  description: 'PaperHouse is a free past papers library for Pakistani Matric and FSc students. No signup, no paywalls, forever free.',
};
