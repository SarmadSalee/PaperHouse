...
export const metadata: Metadata = {
  title: 'Privacy Policy — PaperHouse Pakistan',
  description: 'PaperHouse privacy policy. We do not collect personal data. No accounts, no cookies, no signup required.',
};
