...
export default function Blog() {
  ...
  return (
    <div className="min-h-screen bg-white dark:bg-gray-900">
      <SEOHead
        title="Exam Tips, Board Guides & Past Papers News | PaperHouse Blog"
        description="Study guides, board-wise past paper downloads, and exam tips for Matric & FSc students in Pakistan — all in one place."
        keywords={['matric past papers blog', 'fsc study tips', 'punjab board guides', 'past papers pakistan']}
        canonical="/blog"
      />
