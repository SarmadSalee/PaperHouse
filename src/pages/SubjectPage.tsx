      ...
      <div className="bg-white dark:bg-gray-800 border-b border-gray-100 dark:border-gray-700">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 py-8 text-center">
          <nav className="flex items-center gap-1.5 text-sm text-gray-500 dark:text-gray-400 mb-4 justify-center">
            ...
            <Link to="/subjects" className="hover:text-green-600 transition-colors">Subjects</Link>
            <ChevronRight className="w-3.5 h-3.5" />
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 py-6">
        ...
        {subjectPapers.length === 0 ? (
          <div className="text-center py-16">
            ...
            <Link to="/request" className="inline-flex items-center gap-2 bg-green-600 hover:bg-green-700 text-white font-medium px-6 py-2.5 rounded-full transition-colors">Request a Paper</Link>
          </div>
        ) : (
